...
public class PojoMakerBuildParticipant extends MojoExecutionBuildParticipant {
    ...
    public Set<IProject> build(final int kind, final IProgressMonitor monitor) throws Exception {
        ...
        // getMavenProjectFacade().getMavenProject();
        // final BuildContext buildContext = getBuildContext();
        // boolean skip =
        // Boolean.TRUE.equals(maven.getMojoParameterValue(mavenProject,
        // execution, SKIP,Boolean.class, new NullProgressMonitor()));
        // if(skip){
        // return null;
        // }
        // File staleFile = maven.getMojoParameterValue(mavenProject, execution,
        // STALE_FILE, File.class, new NullProgressMonitor());
        //
        // boolean xnocompile =
        // Boolean.TRUE.equals(maven.getMojoParameterValue(mavenProject,
        ...
        // }
        //
        // if(buildContext.isIncremental() && staleFile!= null &&
        // staleFile.exists()){
        // File wsdlDirectory = maven.getMojoParameterValue(mavenProject,
        // execution, WSDL_DIRECTORY, File.class, new NullProgressMonitor());
        // File bindingDirectory = maven.getMojoParameterValue(mavenProject,
        // execution, BINDING_DIRECTORY, File.class, new NullProgressMonitor());
        ...
        // //ignore if there were no changes to the resources and was an
        // incremental build
        // return null;
        // }
        // }
    ...
    // if (monitor != null) {
    // final String taskName = String.format("CoderPlus M2E: Invoking %s on %s",
    ...
    // }
    //
    // private Set<IProject> executeMojo(final int kind, final IProgressMonitor
